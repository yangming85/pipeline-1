...
func NewObjectStore(
	...
	ostore, err := getProviderObjectStore(secret, resourceGroup, storageAccount)
	if err != nil {
		errors.Wrap(err, "could not create Azure object storage client")
	}
	return &ObjectStore{
		objectStore:    ostore,
		location:       location,
...
func getProviderObjectStore(secret *secret.SecretItemResponse, resourceGroup, storageAccount string) (azureObjectStore, error) {
